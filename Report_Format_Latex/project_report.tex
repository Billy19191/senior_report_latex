...
\def\dissyear{2026}                   % Year of submission
\def\thaidissyear{2569}               % Year of submission (B.E.)
...
Krungsri as a modern and customer-oriented digital bank \cite{techsauce_krungsri}.
...
From the Figure~\ref{fig:sequence-diagram-of-open-account-efcd-product}, the GET /v2/open-account-efcd-product API is responsible for preparing
...
\item \textbf{Mobile Application Distribution}
  ...
  \item \textbf{iOS}: Production builds are submitted via Apple TestFlight for secure external beta testing before the official release on the Apple App Store (Figure~\ref{fig:kkp-better-on-app-store}).
  \end{itemize}
\end{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/2.png}
\caption{User Interface for Request Authentication Feature (1)}\label{fig:user-interface-for-request-authentication-feature-1}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/3.png}
\caption{User Interface for Request Authentication Feature (2)}\label{fig:user-interface-for-request-authentication-feature-2}
\end{figure}
...
experience (Figure \ref{fig:request-authentication-code}).
...
\caption{User Interface for Tax Planning Feature (1)}\label{fig:user-interface-for-tax-planning-feature-1}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=3.52778in]{report_media/media/slide/6.png}
\caption{User Interface for Tax Planning Feature (2)}\label{fig:user-interface-for-tax-planning-feature-2}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=3.52778in]{report_media/media/slide/7.png}
\caption{User Interface for Tax Planning Feature (3)}\label{fig:user-interface-for-tax-planning-feature-3}
\end{figure}
...
\caption{User Interface for Segmentation}\label{fig:user-interface-of-segmentation-167657}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=3.52778in]{report_media/media/slide/10.png}
\caption{User Interface for Segmentation}\label{fig:user-interface-of-segmentation-tier}
\end{figure}
...
\caption{User Interface for Better Box Feature (1)}\label{fig:user-interface-for-better-box-feature-1}
\end{figure}
...
\caption{User Interface for Better Box Feature (2)}\label{fig:user-interface-for-better-box-feature-2}
\end{figure}
...
\caption{User Interface for Better Box Feature (3)}\label{fig:user-interface-for-better-box-feature-3}
\end{figure}
...
\caption{User Interface for Better Box Feature (4)}\label{fig:user-interface-for-better-box-feature-4}
\end{figure}
...
\caption{User Interface for Better Box Feature (5)}\label{fig:user-interface-for-better-box-feature-5}
\end{figure}
...
Flutter development practices (Figure \ref{fig:better-box-code}) and state management approaches to ensure
