...
\def\disscommitteetwo{Dr. Jumpol Polvichai}  % 3rd committee member (optional)
...
\def\disscredit{18}   %% 3 credits or 6 credits
...
\def\thaidisstitleone{แอปพลิเคชันธนาคาร KKP Better}
\def\thaidisstitletwo{}
\def\thaidissauthor{นายสิขเรศ นันทิพัฒน์สกุล}
\def\thaidissauthortwo{นายรัชชานนท์ ทาระวรรณ} %Optional
...
The rapid growth of mobile banking in Thailand has led customers to expect more than basic transactions, demanding integrated financial tools for savings, tax planning, and foreign currency investments in one place. However, Kiatnakin Phatra Bank's existing channels fragmented these services across separate platforms, creating an inconsistent and inconvenient experience. This project addresses this gap by developing KKP Better, a next-generation mobile banking application designed to consolidate these capabilities into a single, high-performance platform.
Among the platform's modules, the project team took primary ownership of five key areas such as Request Authentication, securing high-risk transaction approvals through challenge-response flows, Tax Planning, delivering personalized optimization based on individual financial profiles, Customer Segmentation, enabling tier-based privilege management across KKP's diverse customer base, Better Box, a structured savings feature with intelligent bulk allocation logic, and Ultimate FCD, which automates foreign currency deposit account opening and real-time exchange execution.
Built on Flutter for cross-platform consistency and Go (Golang) microservices for high-concurrency performance, the backend is secured through layered Risk-Based Authentication (RBA), Multi-Factor Authentication (MFA), and asymmetric cryptography to enforce transaction non-repudiation. An API Gateway manages service routing while PostgreSQL ensures ACID-compliant data integrity throughout.
Automated unit testing and high-availability design are embedded across every layer, ensuring production-grade reliability under real banking load. More than an academic exercise, KKP Better is a fully realized, enterprise-ready platform, proof that rigorous engineering, real-world collaboration, and a commitment to user impact can converge to raise the standard of what student-built systems can achieve in the financial industry.

\begin{flushleft}
\begin{tabular*}{\textwidth}{@{}lp{0.8\textwidth}}
\textbf{Keywords}: & Mobile Banking, Digital Banking, Wealth Management, Digital Transformation, Flutter, Microservices, Risk-Based Authentication, Multi-Factor Authentication, API Gateway, PostgreSQL, Unit Testing, High-Availability Design
\end{tabular*}
\end{flushleft}
\endabstract
...
ในปัจจุบัน ลูกค้าธนาคารรายย่อยในประเทศไทยมีความต้องการใช้งานแอปพลิเคชันที่สามารถจัดการด้านการเงินได้อย่างครบวงจรภายในแพลตฟอร์มเดียว อย่างไรก็ตาม ช่องทางของ KKP ในปัจจุบันยังแยกฟีเจอร์ต่าง ๆ ออกจากกัน ทำให้ประสบการณ์การใช้งานยังไม่สะดวกเท่าที่ควร โครงงานนี้จึงพัฒนา “KKP Better” ซึ่งเป็นแอปพลิเคชันโมบายแบงก์กิ้งที่รวมการออม การวางแผนภาษี และการลงทุนในสกุลเงินต่างประเทศไว้ในระบบเดียว เพื่อเพิ่มความสะดวกและประสิทธิภาพในการใช้งาน
ภายในระบบ ทีมผู้พัฒนาได้ออกแบบและพัฒนาฟีเจอร์สำคัญ 5 ส่วน ได้แก่ ระบบยืนยันตัวตนสำหรับธุรกรรมที่มีความเสี่ยงสูง (Request Authentication) ระบบช่วยวางแผนภาษีแบบเฉพาะบุคคล (Tax Planning) ระบบจัดกลุ่มลูกค้าเพื่อรองรับสิทธิประโยชน์ที่แตกต่างกัน (Customer Segmentation) ฟีเจอร์การออมเงินแบบมีเป้าหมายพร้อมการจัดสรรอัตโนมัติ (Better Box) และระบบเปิดบัญชีเงินฝากสกุลเงินต่างประเทศพร้อมการแลกเปลี่ยนเงินแบบเรียลไทม์ (Ultimate FCD)
ระบบถูกพัฒนาด้วย Flutter เพื่อรองรับการทำงานบนหลายแพลตฟอร์ม และใช้สถาปัตยกรรมไมโครเซอร์วิสด้วยภาษา Go เพื่อรองรับการใช้งานจำนวนมากอย่างมีประสิทธิภาพ ในด้านความปลอดภัย มีการใช้การยืนยันตัวตนหลายขั้นตอนและการเข้ารหัสข้อมูล เพื่อป้องกันความเสี่ยงจากธุรกรรม นอกจากนี้ยังมีการใช้ API Gateway ในการจัดการระบบบริการ และฐานข้อมูล PostgreSQL เพื่อให้มั่นใจในความถูกต้องของข้อมูล
นอกจากนี้ ระบบยังถูกออกแบบให้มีความเสถียรสูงและมีการทดสอบอัตโนมัติในทุกส่วน เพื่อให้สามารถรองรับการใช้งานจริงในระดับธนาคารได้อย่างมีประสิทธิภาพ โครงงาน KKP Better จึงไม่เพียงเป็นผลงานเชิงวิชาการ แต่ยังเป็นต้นแบบของระบบที่สามารถนำไปประยุกต์ใช้ในภาคอุตสาหกรรมได้จริง และสะท้อนถึงศักยภาพของการพัฒนาระบบโดยนักศึกษาในการสร้างโซลูชันด้านการเงินที่มีคุณภาพ
...
\textbf{คำสำคัญ}: & Mobile Banking, Digital Banking, Wealth Management, Digital Transformation, Flutter, Microservices, Risk-Based Authentication, Multi-Factor Authentication, API Gateway, PostgreSQL, Unit Testing, High-Availability Design
\end{tabular*}
\end{flushleft}
\endabstract
%\end{thai}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\preface
The authors would like to express their sincere gratitude to Asst. Prof. Rajchawit Sarochawikasit, the project advisor, for his invaluable guidance, insightful suggestions, and continuous support throughout the development of this project. His expertise and encouragement have greatly contributed to the successful completion of this work.
We would also like to extend our appreciation to our mentors, Mr. Attaporn Thanachanrojsakul and Mr. Kaset Soonthornpat, for their professional advice, technical knowledge, and practical insights, which have significantly enhanced the quality and applicability of this project in a real-world context, particularly within the KKP Better Mobile Banking Application .
Furthermore, we would like to thank the faculty members of the Computer Engineering Department, Faculty of Engineering, for providing academic support and a conducive learning environment. Their contributions have played an essential role in shaping our knowledge and skills throughout this study.
Finally, we would like to express our heartfelt gratitude to our families, friends, and colleagues for their encouragement, understanding, and unwavering support during the entire period of this project.
...
APISIX & Apache API Gateway System \\
ASR & Automatic Speech Recognition \\
BFF & Backend for Frontend \\
Bloc & Business Logic Component \\
CDN & Content Delivery Network \\
CI/CD & Continuous Integration / Continuous Delivery \\
CSM & Customer Management Service \\
...
presented in the Gantt chart in Figure \ref{fig:gantt-sem1} and Figure \ref{fig:gantt-sem2} with workload and tasks.

\textbf{First Semester (August 2025 - December 2025)}

The Gantt chart for the first semester presents a detailed timeline of the system development process, focusing primarily on establishing a strong technical foundation and implementing the core features of the application. The development process begins in August with fundamental activities, including the setup of the development environment using Flutter for the frontend and Golang for backend services. At the same time, the system architecture is designed with an emphasis on integration and security to ensure scalability, reliability, and maintainability throughout the project lifecycle.
During September and October, the project progresses into the development phase of the first core feature, Request Authorization. This phase involves implementing authentication mechanisms, handling user requests securely, and ensuring seamless communication between frontend and backend services. In parallel, continuous work on integration and security architecture is carried out to support future feature expansion.
As the project moves into October and November, the development workload increases with the introduction of more complex features such as Tax Planning and Segmentation. These features require more advanced logic, data processing, and system coordination, which is reflected in the longer duration and denser workload shown in the Gantt chart. The team focuses on ensuring that these features are not only functional but also well-integrated into the overall system architecture.
In the final stage of the semester, from November to December, the focus shifts toward documentation, system refinement, and finalizing all implemented features. This includes writing technical documentation, improving code quality, fixing bugs, and optimizing system performance. By the end of the first semester, the system achieves a stable state with all core functionalities implemented and ready for further enhancement. Overall, this semester emphasizes foundational development, core feature implementation, and architectural stability.
...
The Gantt chart for the second semester represents the continuation and expansion of the system with additional features, including Better Box and Ultimate FCD. In January, the project resumes with further system setup and preparation to support new functionalities.
From February to March, the development of the Better Box feature takes place, including components such as Bulk Allocate and Category. Subsequently, from March to April, the Ultimate FCD feature is implemented, covering functionalities like Open Account and Exchange.
In the final phase, from April to May, the project focuses on integrating all components, conducting system testing, and improving overall performance and stability. This semester primarily concentrates on advanced feature development, system integration, and preparing the system for final deployment.
...
connectivity is interrupted \cite{chacon2021progit_v2}. Branching and
...
and rollback capabilities are essential \cite{loeliger2012git}.
...
development kits, and Git integration \cite{microsoft2024vscode_doc}. VS Code's
...
financial software \cite{amos2023practical, microsoft2024vscode_remote}. Its
...
simultaneous connections with minimal overhead \cite{donovan2016go}. Its garbage-collected memory management reduces common issues
...
financial transactions and real-time event streaming \cite{go_doc}.
...
performance on both iOS and Android devices \cite{google2024flutter_overview}. Its
...
experimentation \cite{yu2021cross}. Flutter integrates seamlessly with
...
\cite{google2024flutter_security}.
...
integration into production systems \cite{postman2024platform}). Features such as
...
communication between frontend, backend, and QA teams \cite{zhao2022automated}. The platform integrates with CI/CD pipelines through Newman or
Postman CLI, enabling automated regression testing in continuous
delivery workflows \cite{postman2024platform}. For financial services where secure
...
diverse environments \cite{fowler2006ci}). Jenkins pipelines allow developers
...
or cloud services \cite{jenkins_doc}). Built-in role-based access control
...
on-premise deployments \cite{sharma2021automated}).
...
\cite{google2024firebase_distribution}. Testers receive build updates via email or the Firebase
...
testers with role-based access control \cite{apple2024testflight}. Both platforms
...
contribute to safer and more maintainable code \cite{breslav2017kotlin}.
...
modernization with operational continuity \cite{jetbrains2024kotlin_ref}. Kotlin's
...
long-term ecosystem stability and tooling support \cite{google2024android_basics}.
...
RESTful APIs and enterprise services \cite{johnson2023spring}. Built-in
...
\cite{richardson2018microservices, pivotal2024springboot}.
...
\begin{figure}[H]
\centering
\includegraphics[width=6.26772in,height=2.389in]{report_media/media/image29.png}

\caption{Cloudflare Responsibilities Diagram}\label{fig:cloudflare-responsibilities-diagram}
Source:
\cite{systemweakness_cloudflare}
\end{figure}
...
infrastructure \cite{cloudflare2025waf_overview, cloudflare2025waf_getstarted}.
...
downtime, enabling zero-restart deployment and hot updates \cite{apisix2024getting_started}. Its plugin-based architecture provides features such as
...
status ensure active development and enterprise reliability. \cite{apisix2024high_performance, cncf2024landscape}
...
calls from mobile or web clients \cite{lura2024gateway}. Lura uses a
...
stability. \cite{lura2024gateway}
...
remains responsive under heavy load \cite{redis2025doc}.
...
accountability across all environments \cite{grafana_doc, dynatrace2025what, splunk2025what}.
...
must evolve rapidly while remaining stable and secure \cite{newman2021building}.
...
Source:
\cite{webandcrafts_microservices}
\end{figure}
...
teams \cite{gamma1994design, angelov2020flutter}.
...
\cite{richardson2018microservices, newman2021building}.
...
ensures compliance with security and performance standards \cite{richardson2018microservices, lura_doc_nd}.
...
Source:
\cite{microsoft_microservices_gateway}
\end{figure}
...
\cite{fowler2006ci, github_actions_understanding, jenkins_doc}.
...
while maintaining security and high availability \cite{burns2017designing}.
...
performance, and compliance in financial services \cite{myers2011art}.

\begin{figure}[H]
\centering
\includegraphics[width=5.11979in,height=2.20222in]{report_media/media/image78.png}
\caption{Manual Testing Process}\label{fig:manual-testing-process}
Source:
\cite{esds_manual_testing}
\end{figure}
...
and ensures long-term system integrity \cite{diffie1976new, stallings2017crypto}.

\begin{figure}[H]
\centering
\includegraphics[width=4.42032in,height=1.92887in]{report_media/media/image26.png}
\caption{Private Key Encryption}\label{fig:private-key-encryption}
Source:
\cite{cheapssl_cryptography}
\end{figure}
...
transactions \cite{diffie1976new, stallings2017crypto}.

\begin{figure}[H]
\centering
\includegraphics[width=4.5195in,height=1.7743in]{report_media/media/image64.png}
...
standards of reliability and trust \cite{rivest1978method, nist2020dss}.

\begin{figure}[H]
\centering
\includegraphics[width=5.2619in,height=2.16551in]{report_media/media/image94.png}
\caption{Digital Signature Flow}\label{fig:digital-signature-flow}
Source:
\cite{sectigo_digital_signatures}
\end{figure}
...
ensuring compliance with strict financial security standards \cite{fowler2006ci, owasp2021mstg}.
...
government-backed digital payments and services \cite{macthai2020next}.
...
bank's branding after the TMB--Thanachart merger \cite{thailandinsurance_ttb}.
...
Krungsri Mobile App (KMA) is a comprehensive digital banking platform developed to provide customers with convenient access to a wide range of financial services through a single mobile application. The platform supports essential banking functionalities, including account management, fund transfers, bill payments, credit card services, loan management, and investment tracking. By integrating these services into one unified system, KMA significantly enhances user convenience and reduces the need for customers to access multiple channels.
In addition to core banking services, KMA is closely integrated with Krungsri’s retail and lifestyle ecosystem. The application offers various value-added features such as promotional campaigns, shopping discounts, and partnerships with merchants, allowing users to benefit from exclusive deals directly within the app. This integration reflects Krungsri’s strategy of combining financial services with everyday lifestyle activities, thereby increasing user engagement and retention.
KMA also emphasizes personalization and user experience. The application utilizes data analytics and AI-driven technologies to provide tailored financial recommendations based on user behavior, spending patterns, and financial goals. Real-time notifications are implemented to keep users informed about transactions, account activities, and personalized offers, ensuring that users can manage their finances proactively and efficiently.
From a security perspective, KMA incorporates multiple layers of protection to ensure the safety of user data and transactions. These include two-factor authentication (2FA), biometric login options such as fingerprint and facial recognition, and end-to-end encrypted communication. Such measures are critical in building user trust and ensuring compliance with financial security standards.
Overall, the strength of KMA lies in its ability to seamlessly combine traditional banking services with lifestyle-oriented features, supported by advanced personalization and robust security mechanisms. This positions Krungsri as a modern, customer-centric digital bank that aligns with the evolving expectations of today’s mobile-first users \cite{techsauce_krungsri}.
...
The Figure~\ref{fig:mobile-banking-feature-comparison} presents a comparison
of mobile banking features across five applications: K PLUS, SCB EASY, Krungthai NEXT, Bangkok Bank, and KKP Better.
It evaluates each application based on various feature categories, including rewards programs,
money compartmentalization, AI-based recommendations, financial planning, and core banking functionalities.
The comparison shows that while all applications provide essential banking services,
there are clear differences in the availability of advanced features.

Among the applications, KKP Better stands out as the most comprehensive,
offering a wide range of features including financial planning and money compartmentalization,
which are not commonly available in other apps. K PLUS also performs well by supporting
rewards programs and fund management features, while SCB EASY distinguishes itself by being
the only application that provides AI or personalized recommendations.
In contrast, Krungthai NEXT and Bangkok Bank mainly focus on fundamental
banking services and lack several advanced capabilities.

Despite these differences, all five applications share several core features such as
card and account lock-unlock functions, investment services, loan and credit card applications,
and consolidated asset dashboards. These common features highlight the standard expectations
for modern mobile banking platforms. Overall, the comparison emphasizes that
KKP Better provides a more advanced and integrated financial management experience,
while other applications either specialize in specific features or focus primarily on basic banking functions.

\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=6.7in]{report_media/media/market_compare.png}
...
The development of the KKP Better mobile banking application follows
...
From the Figure~\ref{fig:kkp-better-system-architecture}, the client layer consists of the mobile application developed using
...
\item
  ...
  auditing and incident analysis, as shown in Figures~\ref{fig:example-user-interface-of-elastic-logging} and~\ref{fig:example-user-interface-of-kibana-logging}.
\end{itemize}
...
\item
  ...
  backend services, as shown in Figure~\ref{fig:example-user-interface-of-jenkins-cicd}.
\end{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=2.68599in]{report_media/media/request_authen_user_flow.png}
...
From the Figure~\ref{fig:user-flow-diagram-for-request-authentication}, the flow begins when the user lands on the Home Screen. From here, the
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=2.38889in]{report_media/media/tax_planning_user_flow.png}
...
From the Figure~\ref{fig:user-flow-diagram-for-tax-planning}, the flow begins at the entry point of Flow C, where the system first
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=2.94444in]{report_media/media/segmentation_user_flow.png}
...
From the Figure~\ref{fig:user-flow-diagram-for-segmentation-feature}, this diagram shows a simple decision flow that determines where the user
...
From the Figure~\ref{fig:sequence-diagram-of-customerinformation}, the sequence diagram illustrates the workflow of the GET
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=3.88377in]{report_media/media/privilege_user_flow.png}

\caption{User Flow Diagram for Privilege Feature}\label{fig:user-flow-diagram-for-privilege-feature}
\end{figure}

From the Figure~\ref{fig:user-flow-diagram-for-privilege-feature}, this flow describes how the app handles navigation to a third-party
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=3.06098in]{report_media/media/image20.png}
\caption{Sequence Diagram of customer-privilege-session}\label{fig:sequence-diagram-of-customerprivilegesession}
\end{figure}

From the Figure~\ref{fig:sequence-diagram-of-customerprivilegesession}, the sequence diagram illustrates how the GET /customer-privilege-session
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=2.77778in]{report_media/media/better_box_user_flow.png}
\caption{User Flow Diagram for Better Box Feature}\label{fig:user-flow-diagram-for-better-box-feature}
\end{figure}

From the Figure~\ref{fig:user-flow-diagram-for-better-box-feature}, this flow describes how users interact with the Better Box feature, from
...
\begin{figure}[H]
\centering
\includegraphics[width=5.7in,height=4.42673in]{report_media/media/image57.jpg}
\caption{Sequence Diagram of eligible-pocket}\label{fig:sequence-diagram-of-eligible-pocket}
\end{figure}

From the Figure~\ref{fig:sequence-diagram-of-eligible-pocket}, the sequence diagram illustrates how the GET /v1/eligible-pocket API
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=1.97292in]{report_media/media/ultimated_fcd_user_flow_1.png}
...
From the Figure~\ref{fig:user-flow-diagram-for-ultimate-fcd-feature-open-account}, this flow describes the process of opening a Foreign Currency Deposit
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=1.60417in]{report_media/media/ultimate_fcd_user_flow_2.png}
...
From the Figure~\ref{fig:user-flow-diagram-for-ultimate-fcd-feature-exchange}, this flow describes the process of performing a foreign currency
...
% % \begin{figure}[H]
% % \centering
% % \includegraphics[width=5.8in,height=7.06944in]{report_media/media/image32.png}
...
\item \textbf{Mobile Application Distribution}
  ...
  \begin{itemize}
  \item \textbf{Android}: Production builds are distributed through Firebase App Distribution, leading to the final release on the Google Play Store (Figure~\ref{fig:kkp-better-on-google-play}).
...
\begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\linewidth]{report_media/media/slide/2.png}
    \caption{User Interface Screens of Request Authentication Feature (Loading, List, Result, and Detail Pages)}
    \label{fig:user-interface-for-request-authentication-feature-1}
\end{subfigure}

\begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\linewidth]{report_media/media/slide/3.png}
    \caption{User Interface Screens of Request Authentication Process (PIN Verification, Processing, and Result Pages)}
    \label{fig:user-interface-for-request-authentication-feature-2}
\end{subfigure}
\caption{User Interface for Request Authentication Feature}
\label{fig:user-interface-for-request-authentication-feature}
\end{figure}
...
approve or reject the request (Figures \ref{fig:user-interface-for-request-authentication-feature-1} and \ref{fig:user-interface-for-request-authentication-feature-2}). Authentication is performed using
...
seamless user experience (Figure \ref{fig:jira-tasks-for-request-authentication-development-1})

\begin{figure}[H]
\centering
\includegraphics[width=6.26772in,height=1.58333in]{report_media/media/image84.png}

\caption{Jira Tasks for Request Authentication Development (1)}\label{fig:jira-tasks-for-request-authentication-development-1}
\end{figure}
...
The Verify PIN screen was implemented using a reusable shared component to ensure consistency across the application and reduce code duplication. This screen is specifically designed to support Medium-risk authentication requests, where an additional layer of user verification is required. The implementation focuses on secure input handling, masking sensitive data, and providing immediate feedback in cases of incorrect PIN entry. Moreover, the screen is integrated with the backend authentication service to validate user credentials in real time, ensuring both security and usability. Attention was also given to user experience by keeping the interface simple, responsive, and aligned with the overall design system.
\item
  \textbf{Request Authentication List Screen}
The Request Authentication List screen was developed to display all pending authentication requests in a clear and organized manner. The primary focus of this screen was on efficient data fetching, proper state management, and smooth navigation. Each request item is presented with essential information such as request type, timestamp, and status, allowing users to quickly understand and prioritize actions. Lazy loading and optimized rendering techniques were applied to ensure performance remains stable even when handling multiple requests. Additionally, user interactions were carefully designed so that selecting a request seamlessly navigates the user to the detailed view without delays or confusion.
\item
  \textbf{Request Authentication Details Screen}
The Request Authentication Details screen provides a comprehensive view of each individual request. This includes a well-structured user interface that presents all relevant information, such as request description, associated account details, and risk level indicators. The screen also includes clearly defined Accept and Decline actions, enabling users to respond confidently. The underlying logic was designed to dynamically adapt based on the risk level of the request. For example, higher-risk requests may trigger additional verification steps, such as PIN entry or biometric authentication, before completing the action. This flexible structure ensures both security and scalability for future enhancements.
\item
  \textbf{Request Authentication Result Screens (Accepted/Rejected)}
Separate result screens were implemented for Accepted and Rejected outcomes to provide users with a clear and definitive conclusion after responding to a request. These screens are designed to reduce uncertainty by confirming the action taken and displaying relevant follow-up information when necessary. Visual cues, such as icons and color schemes, were used to differentiate between successful and rejected outcomes, improving user understanding at a glance. Additionally, the screens are structured to maintain consistency with the overall application design, while also reinforcing user confidence through clear messaging and feedback.
\item
  \textbf{Notification Inbox \& Push Notification Integration}
The notification system was developed to enhance real-time communication between the backend system (CSM) and the mobile application. This includes both push notification integration and an in-app notification inbox. When a new authentication request is generated, the system sends a push notification to the user’s device, ensuring timely awareness. Users can tap on the notification to be directly redirected into the Request Authentication flow, minimizing friction and improving response time. The inbox feature allows users to view and manage past notifications, providing a centralized location for tracking all related activities. The implementation also ensures reliable message delivery, proper handling of notification states, and seamless synchronization between the backend and frontend systems.
\end{itemize}
...
all scenarios. Key improvements included (Figure \ref{fig:jira-bugs-for-request-authentication}):

\begin{figure}[H]
\centering
\includegraphics[width=6.26772in,height=1.04167in]{report_media/media/image68.png}

\caption{Jira Bugs for Request Authentication}\label{fig:jira-bugs-for-request-authentication}
\end{figure}
...
\item
  Investigating issues (Figure \ref{fig:request-authentication-code}) related to backend dependencies such as
...
\begin{figure}[H]
\centering
\includegraphics[width=5.26772in,height=3.65278in]{report_media/media/image77.png}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.52778in]{report_media/media/slide/5.png}
\caption{User Interface Screens of Tax Calculation and Tax Rate Summary Feature}\label{fig:user-interface-for-tax-planning-feature-1}
\end{subfigure}

\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.52778in]{report_media/media/slide/6.png}
\caption{User Interface Screens of Tax Input and Tax Deduction Feature}\label{fig:user-interface-for-tax-planning-feature-2}
\end{subfigure}
\caption{User Interface for Tax Planning Feature (continued on next page)}
\end{figure}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.52778in]{report_media/media/slide/7.png}
\caption{User Interface Screens of Tax Result and Tax Planning Summary Feature}\label{fig:user-interface-for-tax-planning-feature-3}
\end{subfigure}
\caption{User Interface for Tax Planning Feature (continued)}
\label{fig:user-interface-for-tax-planning-feature}
\end{figure}
...
recommendations (Figure \ref{fig:user-interface-for-tax-planning-feature-1}, \ref{fig:user-interface-for-tax-planning-feature-2}, and \ref{fig:user-interface-for-tax-planning-feature-3}).
...
included (Figure \ref{fig:jira-tasks-for-tax-planning-development}):
...
system stability (Figure \ref{fig:jira-defects-for-tax-planning-development}):
...
\caption{Jira Defects for Tax Planning}\label{fig:jira-defects-for-tax-planning-development}
\end{figure}
...
\item
  ...
  tax brackets rendered correctly across all scenarios (Figure \ref{fig:tax-planning-code}).
\item
...
\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=3.52778in]{report_media/media/slide/12.png}
\caption{User Interface Screens of Privilege Feature and Related Service Pages}\label{fig:user-interface-for-privilege-feature}
\end{figure}
...
secure APIs to retrieve user point balances and available rewards (Figure \ref{fig:user-interface-for-privilege-feature}).
...
resolved to ensure accurate behavior across the application (Figure \ref{fig:jira-defects-for-privilege-development}).

\begin{figure}[H]
\centering
\includegraphics[width=5.5in,height=0.56944in]{report_media/media/image50.png}
\caption{Jira Defects for Privilege}\label{fig:jira-defects-for-privilege-development}
\end{figure}
...
This improvement prevents outdated UI states (Figure \ref{fig:privilege-code}) and ensures consistent
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.52778in]{report_media/media/slide/9.png}
\caption{User Interface Screens of Customer Segmentation Feature}\label{fig:user-interface-of-segmentation-167657}
\end{subfigure}

\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.52778in]{report_media/media/slide/10.png}
\caption{Customer Segmentation Card Design for Different User Tiers
}\label{fig:user-interface-of-segmentation-tier}
\end{subfigure}
\caption{User Interface for Segmentation}
\label{fig:user-interface-of-segmentation}
...
tiers based on their total financial assets (Figure \ref{fig:user-interface-of-segmentation-167657} and \ref{fig:user-interface-of-segmentation-tier}), including savings and
...
into both backend and frontend components (Figure \ref{fig:jira-tasks-for-segmentation-feature-development}).
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/14.png}
\caption{User Interface Screens of Better Box Overview and Navigation Design}\label{fig:user-interface-for-better-box-feature-1}
\end{subfigure}
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/15.png}
\caption{User Interface Screens of Better Box Setup and Money Allocation Process}\label{fig:user-interface-for-better-box-feature-2}
\end{subfigure}
\caption{User Interface for Better Box Feature (continued on next page)}
\end{figure}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/16.png}
\caption{User Interface Screens of Box Selection and Amount Input Validation}\label{fig:user-interface-for-better-box-feature-3}
\end{subfigure}
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/17.png}
\caption{User Interface Screens of Transaction Review and Error Handling}\label{fig:user-interface-for-better-box-feature-4}
\end{subfigure}
\caption{User Interface for Better Box Feature (continued on next page)}
\end{figure}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/18.png}
\caption{UUser Interface Screens of Transaction Processing, Success, and Box Detail Navigation}\label{fig:user-interface-for-better-box-feature-5}
\end{subfigure}
\caption{User Interface for Better Box Feature (continued)}
\label{fig:user-interface-for-better-box-feature}
\end{figure}
...
without opening multiple accounts (Figure \ref{fig:user-interface-for-better-box-feature-1}, \ref{fig:user-interface-for-better-box-feature-2}, \ref{fig:user-interface-for-better-box-feature-3}, \ref{fig:user-interface-for-better-box-feature-4}, and \ref{fig:user-interface-for-better-box-feature-5}).
...
transaction scenarios. The work is summarized as follows (Figure \ref{fig:jira-tasks-for-better-box-development-1}, \ref{fig:jira-tasks-for-better-box-development-2}, \ref{fig:jira-tasks-for-better-box-development-3}, and \ref{fig:jira-tasks-for-better-box-development-4}):
...
adherence to KKP's stringent security and design standards (Figure \ref{fig:jira-defects-for-better-box-development}, \ref{fig:jira-defects-for-better-box-development-1}, \ref{fig:jira-defects-for-better-box-development-2}, and \ref{fig:jira-defects-for-better-box-development-3}).

\begin{figure}[H]
\centering
\includegraphics[width=6.32813in,height=1.53758in]{report_media/media/image56.png}
\caption{Jira Bugs for Better Box (1)}\label{fig:jira-defects-for-better-box-development}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=6.26772in,height=1.77778in]{report_media/media/image25.png}
\caption{Jira Bugs for Better Box (2)}\label{fig:jira-defects-for-better-box-development-1}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=6.26772in,height=2.79167in]{report_media/media/image83.png}
\caption{Jira Bugs for Better Box (3)}\label{fig:jira-defects-for-better-box-development-2}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=6.26772in,height=1.77778in]{report_media/media/image19.png}
\caption{Jira Bugs for Better Box (4)}\label{fig:jira-defects-for-better-box-development-3}
\end{figure}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/20.png}
\caption{User Interface Screens of Product Selection and Product Highlight Feature}\label{fig:user-interface-for-ultimate-fcd-feature-1}
\end{subfigure}
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/21.png}
\caption{User Interface Screens of Product Details and Currency Selection Process}\label{fig:user-interface-for-ultimate-fcd-feature-2}
\end{subfigure}
\caption{User Interface for Ultimate FCD Feature (continued on next page)}
\end{figure}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/22.png}
\caption{User Interface Screens of Account Information Input and Confirmation Process}\label{fig:user-interface-for-ultimate-fcd-feature-3}
\end{subfigure}
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/23.png}
\caption{User Interface Screens of Terms, Notifications, and Error Handling during Account Opening}\label{fig:user-interface-for-ultimate-fcd-feature-4}
\end{subfigure}
\caption{User Interface for Ultimate FCD Feature (continued on next page)}
\end{figure}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=5.5in,height=3.51389in]{report_media/media/slide/24.png}
\caption{User Interface Screens of Account Opening Results and Status Outcomes}\label{fig:user-interface-for-ultimate-fcd-feature-5}
\end{subfigure}
\caption{User Interface for Ultimate FCD Feature (continued)}
\label{fig:user-interface-for-ultimate-fcd-feature}
\end{figure}
...
display, selection, and confirmation (Figure \ref{fig:user-interface-for-ultimate-fcd-feature-1}, \ref{fig:user-interface-for-ultimate-fcd-feature-2}, \ref{fig:user-interface-for-ultimate-fcd-feature-3}, \ref{fig:user-interface-for-ultimate-fcd-feature-4}, and \ref{fig:user-interface-for-ultimate-fcd-feature-5}). It also supports a resume
...
The development of the Ultimate FCD feature involved a series of tasks (Figure \ref{fig:jira-tasks-for-ultimate-fcd-development-1}, \ref{fig:jira-tasks-for-ultimate-fcd-development-2}, and \ref{fig:jira-tasks-for-ultimate-fcd-development-3})
...
the complexity of the multi-step account opening (Figure \ref{fig:jira-defects-for-ultimate-fcd}). These improvements
...
\caption{Jira Bugs for Ultimate FCD}\label{fig:jira-defects-for-ultimate-fcd}
\end{figure}
...
design alignment and core business logic (Figure \ref{fig:ultimate-fcd-code}). Additionally, inconsistencies
...
The Application Metric Overview dashboard (Figure \ref{fig:application-metric-overview}) provides a comprehensive view
...
at multiple levels, including unit testing (Figure \ref{fig:unit-test-code-example}), integration testing, and
...
95.5\% (Figure \ref{fig:unit-test-deposit}), while the Financial Planning Module reached 100\% coverage (Figure \ref{fig:unit-test-financial}),
